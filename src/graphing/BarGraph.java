...
/**
 * Created by jacobmenke on 5/25/16.
 */
...
public class BarGraph extends JFrame {
    ...
    BarGraph(String firstLine, ArrayList<String> players, ArrayList<String> rankings) {
        setTitle(firstLine);
        setSize(500, 500);
        setVisible(true);
    ...
    public static void main(String[] args) {
        ...
        BarGraph gui = new BarGraph(fd.firstLine, fd.players, fd.rankings);
